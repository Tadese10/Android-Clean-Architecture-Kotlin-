...
import com.example.cleanarchitecture.business.domain.state.*
import com.example.cleanarchitecture.business.domain.util.DateUtil
import com.example.cleanarchitecture.business.interactors.common.DeleteNote.Companion.DELETE_NOTE_PENDING
import com.example.cleanarchitecture.business.interactors.common.DeleteNote.Companion.DELETE_NOTE_SUCCESS
import com.example.cleanarchitecture.business.interactors.notelist.DeleteMultipleNotes.Companion.DELETE_NOTES_ARE_YOU_SURE
import com.example.cleanarchitecture.framework.datasource.cache.database.NOTE_FILTER_DATE_CREATED
import com.example.cleanarchitecture.framework.datasource.cache.database.NOTE_FILTER_TITLE
import com.example.cleanarchitecture.framework.datasource.cache.database.NOTE_ORDER_ASC
import com.example.cleanarchitecture.framework.datasource.cache.database.NOTE_ORDER_DESC
import com.example.cleanarchitecture.framework.presentation.BaseApplication
import com.example.cleanarchitecture.framework.presentation.UIController
import com.example.cleanarchitecture.framework.presentation.common.BaseNoteFragment
import com.example.cleanarchitecture.framework.presentation.common.hideKeyboard
import com.example.cleanarchitecture.framework.presentation.notedetail.NOTE_DETAIL_SELECTED_NOTE_BUNDLE_KEY
import com.example.cleanarchitecture.framework.presentation.notelist.state.NoteListStateEvent
import com.example.cleanarchitecture.framework.presentation.notelist.state.NoteListToolbarState
import com.example.cleanarchitecture.framework.presentation.notelist.state.NoteListViewState
import com.example.cleanarchitecture.util.TodoCallback
import com.example.cleanarchitecture.util.printLogD
import kotlinx.android.synthetic.main.fragment_note_list.*


const val NOTE_LIST_STATE_BUNDLE_KEY = "com.example.cleanarchitecture.framework.presentation.notelist.state"
