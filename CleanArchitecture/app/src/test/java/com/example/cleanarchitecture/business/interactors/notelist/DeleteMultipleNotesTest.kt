...
import com.example.cleanarchitecture.business.data.cache.FORCE_DELETE_NOTE_EXCEPTION
...
import com.example.cleanarchitecture.business.interactors.notelist.DeleteMultipleNotes.Companion.DELETE_NOTES_ERRORS
import com.example.cleanarchitecture.business.interactors.notelist.DeleteMultipleNotes.Companion.DELETE_NOTES_SUCCESS
        ...
        for(index in 0..notesInCache.size){
            ...
            if(index % 2 == 0){
                note = noteFactory.createSingleNote(
                    ...
                    createdAt = notesInCache.get(index).createdAt
                )
